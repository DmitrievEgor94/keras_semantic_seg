...
from models.link_net.Conv2DTranspose import Conv2DTranspose
...
class LinkNet():
    ...
    def get_model(
        ...
        weights_path='models/link_net/linknet_encoder_weights.h5'
    ):
    ...
    def get_encoder(self, name='encoder'):
        ...
        initial1 = Activation(self.activation_function, name=name + '/0/relu_1')(initial1)
    ...
    def encoder_basic_block(
        ...
        x = Activation(self.activation_function, name=name + '/main/relu_1')(x)
        ...
        x = Activation(self.activation_function, name=name + '/relu_1')(x)
        x = Dropout(self.dropout_rate)(x)
    ...
    def get_decoder(self, inputs, name='decoder'):
        ...
        final = Activation(self.activation_function, name=name + '/0/relu_1')(final)
        ...
        final = Activation(self.activation_function, name=name + '/0/relu_2')(final)
    ...
    def decoder_block(
        ...
        x = Activation(self.activation_function, name=name + '/relu_2')(x)
        ...
        x = Activation(self.activation_function, name=name + '/relu_3')(x)
        x = Dropout(self.dropout_rate)(x)
