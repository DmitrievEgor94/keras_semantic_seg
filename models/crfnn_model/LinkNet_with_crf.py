...
from models.crfnn_model.crfrnn_layer import CrfRnnLayer
from models.link_net.Conv2DTranspose import Conv2DTranspose


class LinkNetWithCrf():
    ...
    def get_model(
        ...
        outputs = CrfRnnLayer(image_dims=(self.input_shape[0], self.input_shape[1]),
                              num_classes=self.num_classes,
                              theta_alpha=160.,
                              theta_beta=3.,
                              theta_gamma=3.,
                              num_iterations=10,
                              name='crfrnn')([decoder_out, self.input])

        return Model(inputs=self.input, outputs=outputs, name=self.name)
